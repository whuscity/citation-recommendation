...
class LINE:
    ...
    def get_embeddings(self, emb_filepath):
        self._embeddings = {}
        embs = {}
        if self.order == 'first':
        ...
        for i, embedding in enumerate(embeddings):
            ...
            embs[idx2node[i]] = embedding.tolist()
        json.dump(embs, open(emb_filepath, "w"))
        # json.dump(embs, open(r'C:\Users\zhy\PycharmProjects\zhy\experiment_metric\aan\aan_line.json', "w"))
        # json.dump(embs, open(r'C:\Users\zhy\PycharmProjects\zhy\experiment_metric\dblp\dblp_line.json', "w"))
        print("保存成功")
